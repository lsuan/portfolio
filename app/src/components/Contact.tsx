      ...
      <div id="contact" className="py-5 px-3 px-md-5">
        ...
        <div className="content w-100 d-flex flex-column flex-md-row justify-content-around align-items-center m-auto mb-5 py-4">
          ...
          <div className="contact-form p-3 card col-12 col-md-6">
            <form id="contact-form" name="contact" className="d-flex d-flex flex-column justify-content-between" method="POST" data-netlify="true">
              <div className="inputs">
                <div className="form-floating mb-3">
                  <input type="text" className="form-control" id="name" placeholder="First Last" required={true}/>
                ...
                <div className="form-floating mb-2">
                  <textarea id="message" className="form-control w-100" rows={5} placeholder="Leave a message." required={true}/>
