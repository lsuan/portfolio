...
function Projects() {
  const projects = [
    ...
    },
    {
      ...
      description: "This was my first attempt of incorporating TypeScript into a web project, learning more about its syntax and usage. Furthermore, I dug deeper into my creative side and implemented a clean UI while keeping the site accessible and easy-to-use. I also explored more React components such as Contexts for dark/light mode implementation and CSS Animations for extra pizzazz.",
